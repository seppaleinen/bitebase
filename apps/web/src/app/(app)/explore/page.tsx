            ...
            {showCategoryDropdown && (
              <div className="mt-1 rounded-xl border border-gray-200 bg-white py-1 shadow-lg">
                <button
                  ...
                  className={`w-full px-4 py-2 text-left text-sm ${!selectedCategory ? "bg-violet-50 font-medium text-violet-700" : "text-gray-700 hover:bg-gray-50"}`}
                >
                  All categories
                </button>
                {categories.map((cat) => (
                  <button
                    ...
                    className={`w-full px-4 py-2 text-left text-sm ${selectedCategory === cat.category ? "bg-violet-50 font-medium text-violet-700" : "text-gray-700 hover:bg-gray-50"}`}
                  >
                    {cat.category}
                  </button>
                ))}
